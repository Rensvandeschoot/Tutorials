...
- Installation of R packages `rstan`, and `brms`. This tutorial was made using Blavaan version `r packageVersion("brms")` and Lavaan version `r packageVersion("lavaan")` in R version `r paste0(R.Version()[c("major","minor")], collapse = ".")`
